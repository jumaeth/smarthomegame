      ...
      <div className="flex flex-col items-center justify-center p-4">
        ...
        <div className="text-xl bg-white p-5 rounded-lg text-gray-700 w-full max-w-3xl mb-6">
          <p className="leading-relaxed">
            <Trans>You want to check yourself in the mirror, but it’s still frosted — it won’t work until you set it up. Choose a provider for each app, compare the options, and decide what matters more to you: privacy, or sustainability and comfort. Once all apps are set up, the mirror will clear and you can use it.</Trans></p>
        </div>
    ...
    <div className="modal-content text-white flex flex-col items-center justify-center w-full max-w-[1200px] h-[700px] max-h-[calc(90vh-100px)] box-border overflow-hidden mx-[25px]">
          ...
          <div className="bg-[#2a2a2a] p-3 min-h-[210px] overflow-y-auto h-full">
            {!selectedAppId && (
              <div className="text-gray-400">
                <Trans>Choose an app on the left to view its providers.</Trans>
              </div>
            )}
            {selectedAppId && (
              <div>
                        ...
                        <div className="py-2.5 px-3 overflow-visible">
                          ...
                          <div className="grid grid-cols-2 gap-3 mt-2.5">
                            <div className="min-w-0">
                              <div className="text-gray-300 mb-1"><Trans>Data retention period</Trans></div>
      ...
      <div className="mt-3 text-center w-full">
        {allSolved ? (
          ...
          <span className="text-gray-500"><Trans>Pick a provider for all four apps</Trans></span>
        )}
      </div>
    </div>
  );
