  ...
  return [
    {
      id: "showerhead",
      name: t`Shower Head`,
      question: t`Enable water usage tracking to save up to 30% on your water bill and reduce environmental waste. This AI-powered system monitors your shower patterns in real-time to optimize consumption. However, your water usage data will be shared with sustainability partners for global conservation efforts. Will you prioritize environmental savings over complete privacy?`,
      x: 50,
      y: 20,
      width: 120,
      height: 80,
    ...
    },
    {
      id: "faucet",
      name: t`Faucet`,
      question: t`Enable automatic shut-off after inactivity to prevent water waste and save money. The system detects when you're not using water and shuts off automatically. This requires monitoring your presence and activity patterns. Will you enable this water-saving feature despite the privacy trade-off?`,
      x: 150,
      y: 200,
      width: 100,
      height: 80,
    ...
    },
    {
      ...
      question: t`Enable energy-efficient temperature control to cut heating costs by up to 40% while maintaining comfort. The system learns your preferences and pre-heats water only when needed, reducing energy consumption. This requires monitoring your temperature preferences and usage times. Will you enable this cost-saving feature?`,
      x: 300,
      y: 180,
      width: 120,
      height: 100,
    ...
    },
    {
      id: "rubberducky",
      name: t`Rubber Ducky`,
      question: t`That's just a rubber ducky *squeak*`,
      x: 350,
      y: 40,
      width: 100,
      height: 80,
                            ...
                            <div className="bg-white rounded-xl p-6 w-full max-w-2xl text-center mx-auto">
                              ...
                              <p className="text-base sm:text-xl mb-4 text-gray-700">
                                {isSustainabilityFocused ? (
                                  <Trans>You are sustainability focused! Your choices prioritize environmental benefits and resource conservation.</Trans>
                                ) : (
                                  <Trans>You are privacy focused! Your choices prioritize protecting your personal data and maintaining privacy.</Trans>
                                )}
                              </p>
                            </div>
                          );
