...
export const SmartTv: React.FC<SmartTvProps> = ({ onCompletion }) => {
  ...
  const [options, setOptions] = useState<SmartTvOption[]>([
    ...
    },
    {
      ...
      checked: true,
      warning: t`If you opt out of Smart Home Hub sync, your TV won't be able to control other smart devices like your Smart Light, or respond to home automation.`,
      privacyScore: -0.4,
      comfortScore: 4
    },
    {
    ...
    },
    {
      ...
      label: t`Camera On`,
      checked: true,
      warning: t`If you opt out of camera access, gesture controls and video calling features will not function.`,
      privacyScore: -4,
      comfortScore: 1
    },
    {
      ...
      checked: true,
      warning: t`If you opt out of location services, local content like weather information may not be accurate.`,
      privacyScore: -2.4,
      comfortScore: 1
    },
    {
      ...
      <div className="flex flex-col items-center justify-center p-4">
        ...
        <div className="text-xl bg-white p-5 rounded-lg text-gray-700 w-full max-w-3xl mb-6">
          <p className="leading-relaxed">
            <Trans>Your Smart TV was reset to its default settings. Turn off any settings you don’t need for it to work smartly, and keep the ones that are essential for your viewing experience. Choose wisely — your decisions affect your privacy status.</Trans></p>
        </div>
  ...
  return (
    ...
    <div className="text-2xl text-white px-[30px] py-[12px] w-[800px]">
      ...
      <div className="text-xl px-[5px]">
        <p><Trans>Select the features you want to enable on your Smart TV:</Trans></p>
      ...
      {showReconfigureWarning && (
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 p-5 rounded-lg
          ...
          <p className="mb-4 text-xl">
            <Trans>Your current settings cause more privacy loss than comfort gain, which may not be the best balance for you.</Trans>
          </p>
      ...
      {showSuccessMessage && (
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 p-5 rounded-lg
          ...
          <h3 className="text-2xl font-bold mb-2"><Trans>SmartTV setup complete ✅ </Trans></h3>
          <p className="mb-4 text-xl">
