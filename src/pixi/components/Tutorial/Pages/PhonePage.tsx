...
export const PhonePage: React.FC<PageProps> = ({
  ...
  const textArr = useMemo(() => [
    t`The Smart Home floor plan`,
    t`Clicking on the phone opens the floor plan of the house. Here you can see where each room is located.`,
    t`The rooms`,
    t`In every room, you’ll find some items – some of them are simple furnishings, some smart devices. Adjust their privacy settings and solve the mini-games to unlock your Smart Home! `,
    t`You are here`,
    t`This is where you start the game. Try checking the floor plan if you get lost!`,
    t`The Map`
