...
export class VictoryType {
  ...
  static readonly PERFECT_BALANCE = new VictoryType(
          ...
          PointsLevel.HIGH,
          PointsLevel.HIGH,
          () => t`Perfect Balance: Yippie! You striked the perfect balance. Your Smart Home unlocks smoothly, you ordered your pizza through a secure app, and your friends will arrive soon for a chill night with encrypted Wi-Fi, biometric locks, and good movies. Even your Smart TV compliments you on your data ethics!`,
  ...
  static readonly SMART_DUNGEON = new VictoryType(
          ...
          PointsLevel.LOW,
          PointsLevel.LOW,
          () => t`The Smart Dungeon: Oof - Your Smart Home has gone full rogue! Comfort is non-existent, privacy is compromised— the fridge posts your snack habits online while the thermostat randomly locks at 12°C “for efficiency.”`,
          result_p_low_c_low
  );
  ...
  static readonly CAREFUL_RESIDENCY = new VictoryType(
          ...
          PointsLevel.HIGH,
          PointsLevel.MEDIUM,
          () => t`The Careful Smart Residency: You’ve found a safe but slightly awkward spot. Most systems work — the heating adjusts perfectly, lights respond on cue — but every time you speak, your voice assistant insists on anonymizing your request before acting.`,
          result_p_high_c_mid
  );
  ...
  static readonly EASY_LIFE = new VictoryType(
          ...
          PointsLevel.MEDIUM,
          PointsLevel.HIGH,
          () => t`The Easy Life: Everything feels smooth — the entrance door glides open once the camera detects your friends, playlists anticipate your mood, and your smart oven preheats before you even think of pizza. Some privacy quirks remain.`,
          result_p_mid_c_high
  );
  ...
  static readonly WATCHED_PARTY = new VictoryType(
          ...
          PointsLevel.LOW,
          PointsLevel.MEDIUM,
          () => t`The Watched Party: You’ve managed to regain partial control — lights, doors, and pizza ordering all function, but everything you do seems to be broadcast somewhere. The Smart Mirror recommends new skincare products based on live footage of your face.`,
          result_p_low_c_mid
  );
  ...
  static readonly PRIVACY_FIRST = new VictoryType(
          ...
          PointsLevel.MEDIUM,
          PointsLevel.LOW,
          () => t`Privacy First, Comfort Second: You’ve managed to block third-party access to your personal data, but comfort took a hit. The Smart Heater now requires a fingerprint scan every hour, the lights are stuck in “eco mode” dimness.`,
          result_p_mid_c_low
  );
  ...
  static readonly MINDFUL_HOME = new VictoryType(
          ...
          PointsLevel.MEDIUM,
          PointsLevel.MEDIUM,
          () => t`The Mindful Home: You’ve found a comfortable middle ground — your Smart Home mostly behaves, and your data stays fairly private. The lights adjust after you accept on the Smart App, and the Smart TV only tracks which movies you\'ve watched.`,
          result_p_mid_c_mid
  );
